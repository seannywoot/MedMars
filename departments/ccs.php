...
if (isset($_SESSION['ID']) && isset($_SESSION['user_name'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_patient'])) {
        $stmt = $conn->prepare("INSERT INTO patient (patient_number, last_name, first_name, hospital, gender, age, department) 
                                VALUES (?, ?, ?, ?, ?, ?, ?)");
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_patient'])) {
        $stmt = $conn->prepare("DELETE FROM patient WHERE patient_number = ?");
    ...
    $sql = "SELECT patient_number, last_name, first_name, hospital, gender, age, department FROM patient";
    ...
    <section class="main">
        ...
        <div class="popup-dep" id="popup-dep">
            ...
            <div class="add-form">
                ...
                <form action="ccs.php" method="POST">
                ...
                <table id="patientTable">
                    ...
                    <?php while($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <form action="ccs.php" method="POST" style="display:inline;">
