...
if (isset($_SESSION['ID']) && isset($_SESSION['user_name'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_patient'])) {
        $stmt = $conn->prepare("INSERT INTO cba_list (patient_number, last_name, first_name, hospital, gender, age, department) 
                                VALUES (?, ?, ?, ?, ?, ?, ?)");
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_patient'])) {
        $stmt = $conn->prepare("DELETE FROM cba_list WHERE patient_number = ?");
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_patient'])) {
        ...
        $stmt = $conn->prepare("UPDATE cba_list 
    ...
    $sql = "SELECT patient_number, last_name, first_name, hospital, gender, age, department FROM cba_list";
                ...
                <table id="patientTable">
                    ...
                    <?php while($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <form action="cba.php" method="POST" style="display:inline;">
