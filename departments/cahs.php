...
if (isset($_SESSION['ID']) && isset($_SESSION['user_name'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_patient'])) {
        $stmt = $conn->prepare("INSERT INTO cahs_list (patient_number, last_name, first_name, hospital, gender, age, department) 
                                VALUES (?, ?, ?, ?, ?, ?, ?)");
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_patient'])) {
        $stmt = $conn->prepare("DELETE FROM cahs_list WHERE patient_number = ?");
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_patient'])) {
        ...
        $stmt = $conn->prepare("UPDATE cahs_list 
    ...
    $sql = "SELECT patient_number, last_name, first_name, hospital, gender, age, department FROM cahs_list";
    ...
    <section class="main">
        ...
        <div class="popup-dep" id="popup-dep">
            ...
            <div class="add-form">
                ...
                <form action="cahs.php" method="POST">
                ...
                <table id="patientTable">
                    ...
                    <?php while($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <form action="cahs.php" method="POST" style="display:inline;">
